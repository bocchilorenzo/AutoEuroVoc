...
def sklearn_metrics(y_true, predictions, data_path, language, threshold=0.5):
    ...
    return {
        ...
        'roc_auc_mt': roc_auc_score(y_true=true_labels_mt, y_pred=pred_labels_mt),
        'roc_auc_domain': roc_auc_score(y_true=true_labels_domain, y_pred=pred_labels_domain),
        'precision_mt': precision_score(y_true=true_labels_mt, y_pred=pred_labels_mt, average = 'micro', zero_division=0),
        'precision_domain': precision_score(y_true=true_labels_domain, y_pred=pred_labels_domain, average = 'micro', zero_division=0),
        'recall_mt': recall_score(y_true=true_labels_mt, y_pred=pred_labels_mt, average = 'micro', zero_division=0),
        'recall_domain': recall_score(y_true=true_labels_domain, y_pred=pred_labels_domain, average = 'micro', zero_division=0),
        'hamming_mt': hamming_loss(y_true=true_labels_mt, y_pred=pred_labels_mt),
        'hamming_domain': hamming_loss(y_true=true_labels_domain, y_pred=pred_labels_domain),
        'accuracy_mt': accuracy_score(y_true=true_labels_mt, y_pred=pred_labels_mt),
        'accuracy_domain': accuracy_score(y_true=true_labels_domain, y_pred=pred_labels_domain),
    }, class_report
